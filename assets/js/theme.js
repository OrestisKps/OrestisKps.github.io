...
// Dark mode is forced site-wide: always resolve to "dark" regardless of system
// preference or any previously saved localStorage value.
let determineThemeSetting = () => {
  return "dark";
};

// Dark mode is forced site-wide: the computed theme is always "dark".
...
let initTheme = () => {
  ...
  // No theme toggle button exists in the navbar (dark mode is forced), so there is no
  // click listener to attach here.
};
